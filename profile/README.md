...
**Gubernaut Cognitive Controller (GCC)** — a deterministic,
...
model families (GPT-5.5, Claude Opus 4.8, Gemini 3.5 Flash, and Grok 4.3), 
each serving as both generator and judge. The original three-model
